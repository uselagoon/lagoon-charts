...
install-lagoon-core: install-calico
	$(HELM) upgrade \
		...
		--set logs2email.enabled=true \
		--set logs2microsoftteams.enabled=true \
		--set logs2rocketchat.enabled=true \
		--set logs2slack.enabled=true \
		--set logsDBCurator.enabled=true \
